      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            />
            <p className="text-sm text-gray-500 block text-left">Enter your user name, Email, or Phone number</p>
          </div>
          <div className="space-y-2">
            ...
            />
            <p className="text-sm text-gray-500 block text-left">Enter your Password to sign in into Game Market</p>
          </div>
